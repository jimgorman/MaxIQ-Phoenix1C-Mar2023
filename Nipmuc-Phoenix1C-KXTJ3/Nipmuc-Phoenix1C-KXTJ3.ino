/*
  Program:     Nipmuc-Phoenix1C-KXTJ#.ino
  ...
  xChips:      Barometer - Goertek SPL06-001 https://github.com/domino4com/IWB
               Accelerometer - Rohm Kionix KXTJ3-1057 https://github.com/domino4com/IIA
               Weather - Aosong ASAIR AHT21 https://github.com/domino4com/IWA

Untested with this version of the acceleromenter               
...
#include "kxtj3-1057.h" // Accelerometer
AHTxx aht20(AHTXX_ADDRESS_X38, AHT2x_SENSOR); //sensor address, sensor type
KXTJ3 accel(0x0F); // Address can be 0x0E or 0x0F
...
void logData(){
  ...
  // Read accelerometer
  accelX = accel.axisAccel(X)*0.001;  // reading is in mg the 0.001 converts to g
  accelY = accel.axisAccel(Y)*0.001;
  accelZ = accel.axisAccel(Z)*0.001;
...
void setup(){
  ...
  // setup & check to make sure accelerometer is working
  if (accel.begin(sampleRate, accelRange) == false)
  {
